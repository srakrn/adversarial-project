...
for model_name, (model, _, testloader) in models.items():
    print(f"Unattacked {model_name}")
    print(classification_report(model, testloader))

# %%
for model_name, (model, _, testloader) in models.items():
    print(f"FGSM attacked {model_name}")
    print(classification_report_fgsm(model, testloader))

# %%
for model_name, (model, _, testloader) in models.items():
    print(f"PGD nattacked {model_name}")
    print(classification_report_pgd(model, testloader))
