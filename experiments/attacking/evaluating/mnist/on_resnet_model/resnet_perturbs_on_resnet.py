...
# %%
perturbs = torch.load("perturbs/on_single_point/resnet_on_single_point.pt")
...
# %%
np.save("models/classification_results/on_single_point/resnet_model/resnet_testset.npy", y_pred)
np.save("models/classification_results/on_single_point/resnet_model/resnet_testset_adver.npy", y_pred_adver)
np.save("models/classification_results/on_single_point/resnet_model/resnet_testset_perturbs.npy", y_pred_perturbs)
