...
trainset_pgd_perturbs = torch.load(
    "perturbs/on_single_point/cifar10/cnn_attack_pgd_trainset.pt"
)
testset_pgd_perturbs = torch.load(
    "perturbs/on_single_point/cifar10/cnn_attack_pgd_testset.pt"
)
...
# %%
reinforce_helpers.accuracy_unattacked(model, cifar10_helpers.testloader, desc="Accuracy")
reinforce_helpers.accuracy_attacked(
    model, cifar10_helpers.testloader, testset_pgd_perturbs, desc="PGD accuracy"
)
reinforce_helpers.accuracy_attacked(
    model, cifar10_helpers.testloader, testset_fgsm_perturbs, desc="FGSM accuracy"
)

# %%
train_target, train_perturb, train_km = reinforce.calculate_k_perturbs(
    model,
    cifar10_helpers.cifar10_trainset,
...
ad = reinforce.AdversarialDataset(
    cifar10_helpers.cifar10_trainset, train_target, train_perturb, cuda=False
)
...
# %%
reinforce_helpers.accuracy_unattacked(reinforced_model, cifar10_helpers.testloader, desc="Accuracy")
reinforce_helpers.accuracy_attacked(
    reinforced_model, cifar10_helpers.testloader, testset_pgd_perturbs, desc="PGD accuracy"
)
reinforce_helpers.accuracy_attacked(
    reinforced_model, cifar10_helpers.testloader, testset_fgsm_perturbs, desc="FGSM accuracy"
)
