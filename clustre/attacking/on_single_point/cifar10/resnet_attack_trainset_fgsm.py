...
from helpers.cifar10_helpers import cifar10_resnet_model, cifar10_trainset  # isort:skip
...
# %%
OUTPUT_PATH = "perturbs/on_single_point/cifar10/resnet_attack_fgsm_trainset.pt"
