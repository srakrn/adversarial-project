...
class PerturbsDataset(Dataset):
    ...
    labels = np.load("models/classification_results/on_single_point/fcnn_model/cnn_testset_perturbs.npy")
...
#%%
torch.save(net.state_dict(), "models/weak_learner/on_single_point/fcnn/cnn_perturbs.model")