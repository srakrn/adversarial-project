...
class PerturbsDataset(Dataset):
    ...
    labels = np.load("models/classification_results/on_single_point/cnn_model/fcnn_testset_perturbs.npy")
    ...
    def __getitem__(self, idx):
        return [self.data[idx].reshape(1, 28, 28), self.labels[idx]]
...
#%%
torch.save(net.state_dict(), "models/weak_learner/on_single_point/cnn/fcnn_perturbs.model")